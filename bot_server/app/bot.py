...
class Bot:
    ...
    def __init__(self, jokes: dict, big_model_path: str, name='Григорий'):
        self.name = name
        self.jokes = jokes
        ...
        self.small_model = GenericAssistant('intents.json', intent_methods=mappings,
